...
public class RecordMp3Plugin implements MethodCallHandler, FlutterPlugin {
    ...
    @Override
    public void onMethodCall(MethodCall call, io.flutter.plugin.common.MethodChannel.Result result) {
        switch (call.method) {
            case "start":
    ...
    private void onErrorCallBack(int tag, String msg) {
        ...
        methodChannel.invokeMethod("onRecordError", tag, new io.flutter.plugin.common.MethodChannel.Result() {
            @Override
